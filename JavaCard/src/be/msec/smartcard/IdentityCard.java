...
public class IdentityCard extends Applet {
	...
	private static final byte GET_SERIAL = 0x28;
	...
	private void cryptoOperation(APDU apdu) {
		...
		short sigLength = signature.sign(input, offset , keySizeInBytes, output, (short) 0);
	}
